...
public class Kerkennah extends AppCompatActivity  implements View.OnClickListener  {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_kerkennah);
            getSupportActionBar().hide();
            init();
            ecouteClick();
        }
        private void navigateToActivity(int prixHotel){
            Intent intent = new Intent(com.example.tunisiebooking.Kerkennah.this,Price.class);
